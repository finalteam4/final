 ...
 */
 ...
 // 버튼을 클릭하면 네이버 지도 표시
	$(document).ready(function(){
	    ...
	    var ulsan_ulju_gun_office = new naver.maps.LatLng(35.52246, 129.2425);	//5
	    ...
	    var contentString71 = [
	        ...
	        '<img src="../img/icon/jongno_gu_office.jpg" width="50" height="50" alt="울산중구청" class="thumb" /><br />',
	        '<h3>울산중구청</h3>',
	        '<p><i class="fa-solid fa-location-dot"></i> 울산광역시 중구 단장골길1(복산동)<br />',
	        '<i class="fa-solid fa-phone"></i> 대표전화: 052-290-3000 재난관리: 052-290-4061~67, <br/>',
	        ' (야간,공휴일/당직실)  <i class="fa-solid fa-fax"></i> 052-290-3999 (재난관리): 052-290-4069 <br />',
	        '<i class="fa-solid fa-envelope"></i> 44475 | 공공,사회기관 &gt; 구청<br />',
	        '</p>',
	        '<h3>공식 홈페이지</h3>',
	    ...
	    var contentString72 = [
	        '<div class="emer_office">',
	        '<img src="../img/icon/jongno_gu_office.jpg" width="50" height="50" alt="울산남구청" class="thumb" /><br />',
	        '<h3>울산남구청</h3>',
	        '<p><i class="fa-solid fa-location-dot"></i> 울산광역시 남구 돋질로 233(달동)<br />',
	        '<i class="fa-solid fa-phone"></i> 대표전화: 052-275-7541, <br/>',
	        ' 052-226-5555~8(야간,공휴일/당직실)  <i class="fa-solid fa-fax"></i> 052-226-5559 <br />',
	        '<i class="fa-solid fa-envelope"></i> 44701 | 공공,사회기관 &gt; 구청<br />',
	        '</p>',
	        '<h3>공식 홈페이지</h3>',
	    ...
	    var contentString73 = [
	        '<div class="emer_office">',
	        '<img src="../img/icon/jongno_gu_office.jpg" width="50" height="50" alt="울산동구청" class="thumb" /><br />',
	        '<h3>울산동구청</h3>',
	        '<p><i class="fa-solid fa-location-dot"></i> 울산광역시 동구 봉수로 155(화정동)<br />',
	        '<i class="fa-solid fa-phone"></i> 대표전화: 052-209-3000 해피콜센터: 052-235-8282, <br/>',
	        ' 052-209-3222(야간,공휴일/당직실)  <i class="fa-solid fa-fax"></i> 052-209-3009 (당직실): 052-209-3229 <br />',
	        '<i class="fa-solid fa-envelope"></i> 44021 | 공공,사회기관 &gt; 구청<br />',
	        '</p>',
	        '<h3>공식 홈페이지</h3>',
	    ...
	    var contentString74 = [
	        '<div class="emer_office">',
	        '<img src="../img/icon/jongno_gu_office.jpg" width="50" height="50" alt="울산북구청" class="thumb" /><br />',
	        '<h3>울산북구청</h3>',
	        '<p><i class="fa-solid fa-location-dot"></i> 울산광역시 북구 산업로 1010(연암동)<br />',
	        '<i class="fa-solid fa-phone"></i> 대표전화: 052-241-7000 자연재난: 052-241-7831~4, <br/>',
	        ' (야간,공휴일/당직실)  <i class="fa-solid fa-fax"></i> 052-289-7272 (자연재난): 052-241-7899 <br />',
	        '<i class="fa-solid fa-envelope"></i> 44248 | 공공,사회기관 &gt; 구청<br />',
	        '</p>',
	        '<h3>공식 홈페이지</h3>',
	    ...
	    var marker75 = new naver.maps.Marker({
	        map: map,
	        position: ulsan_ulju_gun_office
	    });
	    var contentString75 = [
	        '<div class="emer_office">',
	        '<img src="../img/icon/jongno_gu_office.jpg" width="50" height="50" alt="울산울주군청" class="thumb" /><br />',
	        '<h3>울산울주군청</h3>',
	        '<p><i class="fa-solid fa-location-dot"></i> 울산광역시 울주군 청량읍 군청로 1<br />',
	        '<i class="fa-solid fa-phone"></i> 대표전화: 052-204-1000, <br/>',
	        ' (야간,공휴일/당직실)  <i class="fa-solid fa-fax"></i>(안전총괄과): 052-204-2319 <br />',
	        '<i class="fa-solid fa-envelope"></i> 44959 | 공공,사회기관 &gt; 구청<br />',
	        '</p>',
	        '<h3>공식 홈페이지</h3>',
